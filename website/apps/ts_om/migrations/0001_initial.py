    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment', models.ForeignKey(to='ts_om.Experiment', on_delete=django.db.models.deletion.PROTECT)),
                ('scenario', models.ForeignKey(to='ts_om.Scenario', on_delete=django.db.models.deletion.PROTECT)),
            ],
        ),
    ]
